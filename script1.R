...
# testing the covolution and recursive filter

#f1 <- 3; f2 <- 1; f3 <- 1;

#filter(1:5,2,method="convolution")
#filter(1:5,c(1,1),method="convolution")
#filter(1:5,c(1,1,1),method="convolution")

#filter(1:5,2,method="recursive")
#filter(1:5,c(1,1),method="recursive")
#filter(1:5,c(1,1,1),method="recursive")
